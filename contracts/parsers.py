...
def parse_sales_person(raw: Optional[str]) -> list:
    ...
    Args:
        raw: 原始字符串，如 "虚构甲" / "虚构戊（联系人） / 虚构己（销售总监）"
    ...
    Examples:
        >>> parse_sales_person("虚构甲")
        ['虚构甲']
        >>> parse_sales_person("虚构戊（联系人） / 虚构己（销售总监）")
        ['虚构戊', '虚构己']
...
#   "投标截止/开标：2026-06-11 09:30" ← 基本信息（合成数据样本）
#   "| 投标截止/开标 | 2026-07-15 |"  ← 里程碑管理
...
_DEADLINE_PATTERNS = {
    ...
    "bid_open_time": [
        ...
        # "投标截止/开标：日期 时间"  合成数据样本（与 bid_deadline 共享日期）
